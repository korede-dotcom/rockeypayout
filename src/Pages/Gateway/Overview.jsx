   ...
   const cardbodys = [
    {
      ...
      downImg: down,
      count:formatters.format(sorted?.total || 0),
      day: "count",
    },
    {
      Image: successful,
      name: `Successful`,
      downImg: down,
      count:formatters.format(sorted?.successful || 0),
      day: "count",
      border: "border",
      padding: "padding",
    },
    {
      ...
      name: "Pending",
      downImg: down,
      count:formatters.format(sorted?.pending || 0),
      day: "count",
      border: "border",
      padding: "padding",
    },
    {
      ...
      name: "Not Submitted",
      downImg: down,
      count:formatters.format(sorted?.initialized || 0),
      day: "count",
      border: "border",
      padding: "padding",
    },
    {
      ...
      name: "failed",
      downImg: down,
      count:formatters.format(sorted?.failed || 0),
      day: "count",
      border: "border",
      padding: "padding",
    },

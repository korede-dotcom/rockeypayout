...
const Marketbox = ({ logo, name, subname, word, subscribe, subStatus,handleSubscribe ,load,handleSubscribed,load2}) => {
  return (
    <MarketBox>
      <div className="top">
      ...
      <div className="bottom">
        <div className="left">
          {subStatus !== true ? 
           ...
           : 
            <p className="unsub" onClick={handleSubscribed}>{"subscribed"}</p>
          }
        </div>
        <div className="right">
          {/* {subStatus !== true && ( */}
